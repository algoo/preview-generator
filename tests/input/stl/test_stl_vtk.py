...
# INFO - G.M - 2019-11-05 - image from https://www.thingiverse.com/thing:182337
# under licence cc-by, created by yahoo Japan
IMAGE_FILE_PATH = os.path.join(CURRENT_DIR, "Whale_t.stl")
